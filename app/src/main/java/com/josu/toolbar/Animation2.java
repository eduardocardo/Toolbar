    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "El FloatingActionButton se desplaza solo gracias al CoordinatorLayout", Snackbar.LENGTH_LONG).show();
            }
        });
        ...
        //getSupportActionBar().setTitle("Animacion 2");

        //CollapsingToolbarLayout
        ctlLayout = (CollapsingToolbarLayout)findViewById(R.id.ctlLayout);
        ctlLayout.setTitle("Animacion 2");
